...
async function getTransporter() {
  ...
  if (!pass) {
    console.log('[SMTP Send API] GMAIL_APP_PASSWORD is blank. Attempting Firestore DB credentials fallback.');
    ...
    if (dbSettings && dbSettings.gmailAppPassword) {
      ...
      console.log('[SMTP Send API] Loaded credentials from Firestore successfully.');
    }
  }
